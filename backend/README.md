...
## Project Structure
    ...
    ├── testing_django_app_31743  # Django project configurations
...
1. Clone this repo and `cd testing_django_app_31743`
...
2. Clone this repo and `cd testing_django_app_31743`
